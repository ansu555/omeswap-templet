...
export default function BacktestSummaryModal() {
  ...
  const { totalTicks, markersPlaced, signalsFired, skippedNodes, durationMs } =
    backtestSummary;
      ...
      >
        ...
        >
          {[
            ...
            {
              label: "Chart markers placed",
              value: markersPlaced.toLocaleString(),
            },
        ...
        {skippedNodes.length > 0 && (
          ...
          >
            ...
            <p className="text-[10px] text-amber-400/80 leading-relaxed">
              Simulated in backtest:{" "}
              <span className="font-medium text-amber-400">
                {skippedNodes.join(", ")}
              </span>
              . No real transactions were executed.
            </p>
          </div>
        )}
