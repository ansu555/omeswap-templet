# Graph Report - components/ui  (2026-04-18)

## Corpus Check
- Corpus is ~23,637 words - fits in a single context window. You may not need a graph.

## Summary
- 120 nodes · 56 edges · 66 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Pill Nav|Pill Nav]]
- [[_COMMUNITY_Text Pressure|Text Pressure]]
- [[_COMMUNITY_Pagination|Pagination]]
- [[_COMMUNITY_Variable Proximity|Variable Proximity]]
- [[_COMMUNITY_Stats Widget|Stats Widget]]
- [[_COMMUNITY_Chatbot Panel|Chatbot Panel]]
...
1. `layout()` - 2 edges
2. `onResize()` - 2 edges
3. `isExternalLink()` - 2 edges
4. `isRouterLink()` - 2 edges
...
### Community 0 - "Pill Nav"
Cohesion: 0.22
Nodes (4): isExternalLink(), isRouterLink(), layout(), onResize()

### Community 1 - "Text Pressure"
Cohesion: 0.29
Nodes (0): 

### Community 2 - "Pagination"
Cohesion: 0.33
Nodes (0): 

### Community 3 - "Variable Proximity"
Cohesion: 0.4
Nodes (0): 

### Community 4 - "Stats Widget"
Cohesion: 0.4
Nodes (0): 

### Community 5 - "Chatbot Panel"
Cohesion: 0.5
Nodes (0): 
...
### Community 11 - "Button Group"
Cohesion: 1.0
Nodes (0): 

### Community 12 - "Carousel"
Cohesion: 1.0
Nodes (0): 

### Community 13 - "Decrypted Text"
Cohesion: 1.0
Nodes (0): 
...
### Community 18 - "Liquid Ether"
Cohesion: 1.0
Nodes (0): 

### Community 19 - "Skeleton"
Cohesion: 1.0
Nodes (0): 
...
### Community 21 - "Spinner"
Cohesion: 1.0
Nodes (0): 

### Community 22 - "Accordion"
Cohesion: 1.0
Nodes (0): 
...
### Community 33 - "Command"
Cohesion: 1.0
Nodes (0): 

### Community 34 - "Context Menu"
Cohesion: 1.0
Nodes (0): 

### Community 35 - "Conversation"
Cohesion: 1.0
Nodes (0): 
...
### Community 41 - "Hover Card"
Cohesion: 1.0
Nodes (0): 

### Community 42 - "Input Otp"
Cohesion: 1.0
Nodes (0): 
...
### Community 47 - "Nav Bar"
Cohesion: 1.0
Nodes (0): 

### Community 48 - "Navigation Menu"
Cohesion: 1.0
Nodes (0): 
...
### Community 50 - "Progress"
Cohesion: 1.0
Nodes (0): 

### Community 51 - "Radio Group"
Cohesion: 1.0
Nodes (0): 

### Community 52 - "Resizable"
Cohesion: 1.0
Nodes (0): 

### Community 53 - "Scroll Area"
Cohesion: 1.0
Nodes (0): 
...
### Community 64 - "Tooltip"
Cohesion: 1.0
Nodes (0): 

### Community 65 - "Tubelight Navbar"
Cohesion: 1.0
Nodes (0): 
...
- **Thin community `Button Group`** (2 nodes): `ButtonGroup()`, `button-group.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Carousel`** (2 nodes): `useCarousel()`, `carousel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Decrypted Text`** (2 nodes): `DecryptedText()`, `decrypted-text.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Empty`** (2 nodes): `cn()`, `empty.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Field`** (2 nodes): `cn()`, `field.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Input Group`** (2 nodes): `input-group.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Kbd`** (2 nodes): `kbd.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Liquid Ether`** (2 nodes): `liquid-ether.tsx`, `LiquidEther()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Spinner`** (2 nodes): `spinner.tsx`, `Spinner()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Accordion`** (1 nodes): `accordion.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Actions`** (1 nodes): `actions.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Alert Dialog`** (1 nodes): `alert-dialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Alert`** (1 nodes): `alert.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Aspect Ratio`** (1 nodes): `aspect-ratio.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Avatar`** (1 nodes): `avatar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Breadcrumb`** (1 nodes): `breadcrumb.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Button`** (1 nodes): `button.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Card`** (1 nodes): `card.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Checkbox`** (1 nodes): `checkbox.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Collapsible`** (1 nodes): `collapsible.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Command`** (1 nodes): `command.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Context Menu`** (1 nodes): `context-menu.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Conversation`** (1 nodes): `conversation.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Dialog`** (1 nodes): `dialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Drawer`** (1 nodes): `drawer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Dropdown Menu`** (1 nodes): `dropdown-menu.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Form`** (1 nodes): `form.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Gauge`** (1 nodes): `gauge.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Hover Card`** (1 nodes): `hover-card.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Input Otp`** (1 nodes): `input-otp.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Input`** (1 nodes): `input.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Label`** (1 nodes): `label.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Menubar`** (1 nodes): `menubar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Message`** (1 nodes): `message.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Nav Bar`** (1 nodes): `nav-bar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Navigation Menu`** (1 nodes): `navigation-menu.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Popover`** (1 nodes): `popover.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Scroll Area`** (1 nodes): `scroll-area.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Select`** (1 nodes): `select.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Separator`** (1 nodes): `separator.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Sheet`** (1 nodes): `sheet.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Slider`** (1 nodes): `slider.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Switch`** (1 nodes): `switch.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Table`** (1 nodes): `table.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Tabs`** (1 nodes): `tabs.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Textarea`** (1 nodes): `textarea.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Tooltip`** (1 nodes): `tooltip.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Tubelight Navbar`** (1 nodes): `tubelight-navbar.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
